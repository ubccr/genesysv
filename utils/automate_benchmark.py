...
command_10_samples = "bash es_scripts/delete_index_ten_samples.sh; bash es_scripts/create_index_ten_samples_and_put_mapping_ten_samples.sh; python import_vcf_using_celery.py --hostname 172.17.39.0 --port 9200 --index ten_samples --type ten_samples --label None --update False --vcf ~/%s --mapping es_scripts/inspect_output_for_ten_samples_ten_samples.txt;"
command_100_samples = "bash es_scripts/delete_index_hundred_samples.sh; bash es_scripts/create_index_hundred_samples_and_put_mapping_hundred_samples.sh; python import_vcf_using_celery.py --hostname 172.17.39.0 --port 9200 --index hundred_samples --type hundred_samples --label None --update False --vcf ~/%s --mapping es_scripts/inspect_output_for_hundred_samples_hundred_samples.txt;"
command_500_samples = "bash es_scripts/delete_index_five_hundred_samples.sh; bash es_scripts/create_index_five_hundred_samples_and_put_mapping_five_hundred_samples.sh; python import_vcf_using_celery.py --hostname 172.17.39.0 --port 9200 --index five_hundred_samples --type five_hundred_samples --label None --update False --vcf ~/%s --mapping es_scripts/inspect_output_for_five_hundred_samples_five_hundred_samples.txt;"
command_1000_samples = "bash es_scripts/delete_index_thousand_samples.sh; bash es_scripts/create_index_thousand_samples_and_put_mapping_thousand_samples.sh; python import_vcf_using_celery.py --hostname 172.17.39.0 --port 9200 --index thousand_samples --type thousand_samples --label None --update False --vcf ~/%s --mapping es_scripts/inspect_output_for_thousand_samples_thousand_samples.txt;"
