...
#		json.dump(mapping, fp, sort_keys=True, indent=2, ensure_ascii=False)
	...
	return(create_index_script, mapping)

# this is a messy code, need improvment!!!
def make_gui(vcf_info, mapping):
	...
	outputfile = os.path.basename(args.vcf).replace('.vcf.gz', '_gui_config.json')
...
if __name__ == '__main__':
	...
	create_index_script, mapping = make_es_mapping(vcf_info)
