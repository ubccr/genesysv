curl -XPUT '199.109.192.82:9200/sim?pretty' -H 'Content-Type: application/json' -d'
{
  "settings": {
...
curl -XPUT '199.109.192.82:9200/sim/_mapping/wes?pretty' -H 'Content-Type: application/json' -d'
{
  "properties": {
    "1000g2015aug_afr": {
      "type": "float"
