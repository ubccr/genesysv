...
class FilterFieldAdmin(admin.ModelAdmin):
    list_display = ('display_text', 'dataset', 'in_line_tooltip', 'tooltip', 'form_type', 'widget_type',
...
class AttributeFieldAdmin(admin.ModelAdmin):
    list_display = ('display_text', 'dataset', 'es_name',
                    'path', 'place_in_panel', 'is_visible', )
    list_filter = ('dataset',)
    search_fields = ('display_text',)
...
class VariantReviewStatusHistoryAdmin(admin.ModelAdmin):
    list_display = ('pk', 'variant_review_status',
