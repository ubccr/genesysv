...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dataset_object = Dataset.objects.get(name='sim_case_wes')
       ...
       ##
        ...
        for es_name, es_filter_type in filter_panel:
            ...
            filter_field_obj = FilterField.objects.get(dataset=dataset_object, es_name=es_name, es_filter_type__name=es_filter_type)
       ...
       ##
        ...
        for es_name, path in attribute_panel:
            print(es_name, path)
            attribute_field_obj = AttributeField.objects.get(dataset=dataset_object, es_name=es_name, path=path)
