...
urlpatterns = (
    ...
    url(r'^variant/(?P<dataset_id>[0-9]+)/(?P<variant_id>.*)/$',
        get_variant, name='get-variant'),
    ...
    url(r'^(?P<pk>[0-9]+)$', retrieve_saved_search,
        name='retrieve-saved-search'),
    url(r'^saved_search/update/(?P<pk>[0-9]+)/$',
        SavedSearchUpdate.as_view(), name='saved-search-update'),
    url(r'^saved_search/delete/(?P<pk>[0-9]+)/$',
        SavedSearchDelete.as_view(), name='saved-search-delete'),
    url(r'^update-variant-review-status/$', update_variant_review_status,
        name='update-variant-review-status'),
    url(r'^list-variant-review-summary/$', list_variant_review_summary,
        name='list-variant-review-summary'),
    url(r'^delete-variant/(?P<pk>[0-9]+)$',
        delete_variant, name='delete-variant'),
    url(r'^edit-variant/(?P<pk>[0-9]+)$',
        VariantReviewStatusUpdateView.as_view(), name='edit-variant'),
